        ...
        <div style={{ width: isMobile ? '100%' : 260, flexShrink: 0, background: sidebarBg, borderRight: `1px solid ${border}`, display: 'flex', flexDirection: 'column', position: isMobile ? 'fixed' : 'relative', inset: isMobile ? 0 : 'auto', zIndex: 50 }}>
          ...
          <div style={{ padding: '0 10px 6px' }}>
            ...
            {[
              ...
              { label: 'LexTrack', desc: 'Live case tracking', path: '/track', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 15"/></svg>, color: '#C7A56A' },
              ...
              { label: 'LexPulse', desc: 'Legal news', path: '/pulse', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><polyline points="2 12 6 12 8 5 11 19 14 9 16 15 18 12 22 12"/></svg>, color: '#3fb950' },
              ...
              { label: 'About', desc: 'About LexIndia', path: '/about', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><circle cx="12" cy="12" r="9"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>, color: '#C7A56A' },
            ].map(t => (
